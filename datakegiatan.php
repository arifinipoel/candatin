    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            ...
            <section class="content-header">
                <h1>
                    Master Kegiatan Tahun <?php echo "$_SESSION[tahun]"; ?>
                    <h4></h4>
                </h1>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><b>Tambah Data Kegiatan</b></h5>
                        ...
                        <div class="modal-body">
                            <table width="606" border="0">
                                <form role="form" method="post" action="qinsert_datakegiatan" onsubmit="return validasi_input(this)" enctype='multipart/form-data'>

                                    <tr>
                                        <td>Kode Kegiatan <font color="red">*)</font>
                                        </td>
                                        <td><input type="text" size='35' name='kode_kegiatan' class="form-control" id="inputFirstname" required></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Kegiatan <font color="red">*)</font>
                                        </td>
                                        <td><textarea class="form-control" name="nama_kegiatan" id="cmbProvinsi" cols="30" required></textarea></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>Deskripsi <font color="red">*)</font>
                                        </td>
                                        <td><textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" required></textarea></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                    </tr>
                            ...
                            <div class="box-body table-responsive">
                                <table id="tabelPegawai" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        $qryx = "select * from tm_kegiatan where tahun='$_SESSION[tahun]'";
                                                ...
                                                <div class="modal fade" id="editModal_<?php echo $yapx['idkegiatan']; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel_<?php echo $yapx['idkegiatan']; ?>" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="editModalLabel_<?php echo $yapx['idkegiatan']; ?>">Edit Data Kegiatan</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            ...
                                                            <div class="modal-body">
                                                                <table width="606" border="0">
                                                                    <form role="form" method="post" action="qedit_datakegiatan" onsubmit="return validasi_input(this)" enctype='multipart/form-data'>
                                                                        <input type="hidden" name="idkegiatan" value="<?php echo "$yapx[idkegiatan]"; ?>">
                                                                        <tr>
                                                                            <td>Kode Kegiatan <font color="red">*)</font>
                                                                            </td>
                                                                            <td><input type="text" size='35' name='kode_kegiatan' value="<?php echo $yapx['kode_kegiatan']; ?>" class="form-control" id="kode_kegiatan" required></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td><textarea class="form-control" name="nama_kegiatan" id="nama_kegiatan" cols="30" required><?php echo $yapx['nama_kegiatan']; ?></textarea></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="text" size='35' name='deskripsi' value="<?php echo $yapx['deskripsi']; ?>" class="form-control" id="deskripsi" required></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                        </tr>
