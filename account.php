...
session_start();
if($_SESSION['tipe_login']!="1" and $_SESSION['tipe_login']!="4"){//melakukan pengalihan
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Ubah Password<br>
                        <h4><?php //echo "$_POST[namasubkegiatan]";?></h4>
                    </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                               ...
                               <form method="post" action="accountEditConfirm" onsubmit="return validasi_input(this)">	 
                                    <div class="box-body">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary"  onclick="return confirm('Apakah anda akan merubah password, jika ya silahkan login dengan pasword yang baru ?')">Simpan</button>
                                        </form><br><br>
