            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h3>
						...
						Komponen/Sub Komponen <?php echo "$_REQUEST[kode_subkegiatan]";?>
                        <h4></h4>
                    </h3>
						...
						<div class="modal fade" id="exampleModalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                    ...
                                    <div class="modal-dialog" role="document">
											...
											<!--
											 <tr>
												<td>Kegiatan <font color="red"></font></td>
											...
											!-->
											 <tr>
												<td>Kode Belanja<font color="red">*)</font></td>
												<td><input type="text" size='35' name='kode_komponen' class="form-control" id="inputFirstname" required></td>
											  </tr>
											  <tr>
												<td></td>
											  </tr>
											  <tr>
												<td>Jenis Belanja <font color="red">*)</font> </td>
												<td><input type="text" size='35' class="form-control" name="nama_komponen" id="cmbProvinsi" cols="30" required></td>
											  </tr>
											  <tr>
												<td></td>
											  </tr>
										...
										<div class="modal-dialog modal-lg" role="document">
										  <div class="modal-content">
											 ...
											 <tr>
												...
												<td><input type="text" size='35' name='kode_komponen' value="<?php echo $yapx['kode_komponen']; ?>" class="form-control" id="inputFirstname" required></td>
											  </tr>
											  <tr>
												<td></td>
											  </tr>
											  <tr>
												<td>Jenis Belanja <font color="red">*)</font> </td>
												<td><textarea class="form-control" name="nama_komponen" id="cmbProvinsi" cols="30" required><?php echo $yapx['nama_komponen']; ?></textarea></td>
											  </tr>
											  <tr>
												<td></td>
											  </tr>
											  ...
											  <tr>
												...
												<?php            
                                                 $selected = "";
												 if($yapx['tagging'] == "none")
                                                 {
												    echo "<OPTION value='none' selected>none</option>";
													echo "<OPTION value='perjadin'>perjadin</option>";
                                                    echo "<OPTION value='non_perjadin'>non_perjadin</option>";     
                                                 }	
                                                 elseif($yapx['tagging'] == "perjadin")
                                                 {
												    echo "<OPTION value='none'>none</option>";
													echo "<OPTION value='perjadin' selected>perjadin</option>";
                                                    echo "<OPTION value='non_perjadin'>non_perjadin</option>";     
                                                 }	
												 elseif($yapx['tagging'] == "non_perjadin")
                                                 {
													echo "<OPTION value='none'>none</option>";
                                                    echo "<OPTION value='perjadin'>perjadin</option>";
                                                    echo "<OPTION value='non_perjadin' selected>non_perjadin</option>";
                                                 }
												 else
                                                 {
